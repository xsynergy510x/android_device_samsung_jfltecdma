...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('set_perm(0, 0, 0755, "/system/bin/efsks");')
  info.script.AppendExtra('set_perm(0, 0, 0755, "/system/bin/ks");')
  info.script.AppendExtra('set_perm(0, 0, 0755, "/system/bin/qcks");')
