...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('ifelse(is_substring("I545", getprop("ro.bootloader")), package_extract_dir("install/vzw", "/system");')
  ...
  info.script.AppendExtra('ifelse(is_substring("L720", getprop("ro.bootloader")), package_extract_dir("install/spr", "/system");')
  info.script.AppendExtra('ifelse(is_substring("R970", getprop("ro.bootloader")), package_extract_dir("install/r970", "/system");')
